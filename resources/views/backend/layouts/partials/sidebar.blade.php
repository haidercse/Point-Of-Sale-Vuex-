                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li class="{{ Route::is('home') ? 'active' : '' }}">
                                <a href="javascript:void(0)" aria-expanded="true"><i class="fas fa-home"></i><span>Dashboard</span></a>
                                <ul class="collapse">
                                    <li class="{{ Route::is('home') ? 'active' : '' }}"><a href="{{ route('home') }}">Dashboard Page</a></li>
                                    
                                </ul>
                            </li>
                            <li class="{{ Route::is('user.index') ? 'active' : '' }}">
                                <a href="javascript:void(0)" aria-expanded="true"><i class="fas fa-user"></i><span>User Management
                                    </span></a>
                                <ul class="collapse">
                            ...
                            <li class="{{ Route::is('category.index') ? 'active' : '' }}">
                                <a href="javascript:void(0)" aria-expanded="true"><i class="fas fa-list"></i><span>Category Management
                                    </span></a>
                                <ul class="collapse">
                            ...
                            <li class="{{ Route::is('brand.index') ? 'active' : '' }}">
                                <a href="javascript:void(0)" aria-expanded="true"><i class="fas fa-list"></i><span>Brand Management
                                    </span></a>
                                <ul class="collapse">
                            ...
                            <li class="{{ Route::is('size.index') ? 'active' : '' }}">
                                <a href="javascript:void(0)" aria-expanded="true"><i class="fas fa-list"></i><span>Size Management
                                    </span></a>
                                <ul class="collapse">
                            ...
                            <li class="{{ Route::is('product.index') ? 'active' : '' }}">
                                <a href="javascript:void(0)" aria-expanded="true"><i class="fas fa-list"></i><span>Product Management
                                    </span></a>
                                <ul class="collapse">
                            ...
                            <li class="{{ Route::is('product.stock.in') ? 'active' : '' }}">
                                <a href="javascript:void(0)" aria-expanded="true"><i class="fas fa-sticky-note"></i><span>Product Stock Management
                                    </span></a>
                                <ul class="collapse">
                            ...
                            <li class="{{ Route::is('product.stock.history') ? 'active' : '' }}">
                                <a href="javascript:void(0)" aria-expanded="true"><i class="fas fa-sticky-note"></i><span>Product Stock History
                                    </span></a>
                                <ul class="collapse">
                            ...
                            <li class="{{ Route::is('return.product') ? 'active' : '' }}">
                                <a href="javascript:void(0)" aria-expanded="true"><i class="fas fa-exchange-alt"></i><span>Return Product Management
                                    </span></a>
                                <ul class="collapse">
                            ...
                            <li class="{{ Route::is('return.product.history') ? 'active' : '' }}">
                                <a href="javascript:void(0)" aria-expanded="true"><i class="fas fa-exchange-alt"></i><span>Return Product History
                                    </span></a>
                                <ul class="collapse">
                            ...
                            <li class="{{ Route::is('user.logout') ? 'active' : '' }}">
                                <a href="javascript:void(0)" aria-expanded="true"><i class="fas fa-sign-out"></i><span>Logout User
                                    </span></a>
                                <ul class="collapse">
